...
import HeroSectionTeste from '../(public)/_components/HeroSectionTeste'
import FeaturedProducts from '../(public)/_components/FeaturedProducts'
import HowItWorks from '../(public)/_components/HowItWorks'
import BrandStory from '../(public)/_components/BrandStory'
import FinalCTA from '../(public)/_components/FinalCTA'
import HomeWrapper from '../(public)/_components/HomeWrapper'
