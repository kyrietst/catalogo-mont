    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-20 pointer-events-none">
                ...
                <FloatingCheeseBread
                    size="xl"
                    className="absolute bottom-[10%] -right-[5%] md:right-[5%] opacity-90 shadow-2xl"
                    ref={addToRefs}
                />
                <FloatingCheeseBread
                    size="sm"
            ...
            <div className="relative z-30 container mx-auto px-4 text-center">
                ...
                >
                    <span className="block overflow-hidden"><span className="word inline-block">Pronto</span> <span className="word inline-block">para</span></span>
                    <span className="block overflow-hidden"><span className="word inline-block">experimentar</span> <span className="word inline-block">o</span> <span className="word inline-block">sabor?</span></span>
                </h2>

                <p className="text-mont-cream/90 text-lg md:text-xl max-w-2xl mx-auto mb-10 hero-content-fade">
                    Peça agora e receba em casa. O verdadeiro pão de queijo artesanal.
                </p>
